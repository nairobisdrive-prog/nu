  ...
  return (
    <div className="min-h-screen bg-[#F5F3EF] pt-16">
      <div className="max-w-7xl mx-auto px-5 lg:px-10">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-12 pt-12">
          <h1 className="text-4xl font-bold text-[#141821] mb-4">Xa&apos;an Blog</h1>
          <p className="text-[#756791] max-w-2xl mx-auto">Tips, guides, and insights for renting in Mexico</p>
        </motion.div>
              ...
              <motion.article key={post.id}
                ...
                <Link href={`/blog/${post.slug}`} className="group block">
                  ...
                  <div className="p-4">
                    ...
                    <h3 className="text-xl font-bold text-[#141821] group-hover:text-[#5B25C1] transition-colors line-clamp-2">{post.title}</h3>
