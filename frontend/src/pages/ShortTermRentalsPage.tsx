    ...
    <div className="bg-white rounded-2xl shadow-md overflow-hidden group cursor-pointer hover:shadow-xl transition-shadow duration-300">
      ...
      <div className="p-3">
        ...
        <p className="text-sm font-semibold text-[#5B25C1]">
          ...
          <span className="text-xs font-normal text-[#756791]">/n</span>
        </p>
      </div>
    </div>
  );
            ...
            <div className="max-w-7xl mx-auto">
              <div className="bg-gray-50 rounded-2xl p-6 border border-gray-100">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-[#756791] uppercase tracking-wider mb-2">Min Price /n</label>
                    <input
                      type="number"
                      placeholder="$0"
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-[#756791] uppercase tracking-wider mb-2">Max Price /n</label>
                    <input
                      type="number"
                      placeholder="$10,000"
              ...
              <>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
                  {properties.map((property, index) => (
                    <ShortTermCard key={property.id} property={property} index={index} />
                  ))}
                </div>
